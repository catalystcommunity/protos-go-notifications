...
type ScheduledNotification struct {
	...
	Notification *NotificationEvent `protobuf:"bytes,2,opt,name=notification,proto3" json:"notification,omitempty"`
...
type ScheduledNotification_ExecuteOnceTrigger struct {
	ExecuteOnceTrigger *ExecuteOnceTrigger `protobuf:"bytes,4,opt,name=execute_once_trigger,json=executeOnceTrigger,proto3,oneof"`
}

type ScheduledNotification_CronTrigger struct {
	CronTrigger *CronTrigger `protobuf:"bytes,5,opt,name=cron_trigger,json=cronTrigger,proto3,oneof"`
}
...
var file_notifications_v1alpha1_api_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xce, 0x02, 0x0a, 0x15, 0x53, 0x63, 0x68, 0x65, 0x64,
	...
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x41, 0x66, 0x74,
	0x65, 0x72, 0x12, 0x5e, 0x0a, 0x14, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x5f, 0x6f, 0x6e,
	0x63, 0x65, 0x5f, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b,
	...
	0x65, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x6e, 0x6f, 0x74, 0x69, 0x66,
